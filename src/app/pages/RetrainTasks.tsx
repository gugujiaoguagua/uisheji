...
export default function RetrainTasks() {
  ...
  const retrainTasksSectionVisibility = {
    headerDescription: false,
    overviewStats: false,
    taskDescription: false,
    taskMeta: false,
    completionLoopPanel: false,
    suggestionSidebar: false,
    quickLinksSidebar: false,
  } as const;



  const showRetrainTasksRightSidebar =
    retrainTasksSectionVisibility.suggestionSidebar || retrainTasksSectionVisibility.quickLinksSidebar;

  const retrainTasksLayoutClass = showRetrainTasksRightSidebar
    ? "max-w-5xl mx-auto px-4 md:px-6 py-4 grid md:grid-cols-3 gap-4"
    : "max-w-5xl mx-auto px-4 md:px-6 py-4";

  const retrainTasksMainColumnClass = showRetrainTasksRightSidebar ? "md:col-span-2 space-y-4" : "space-y-4";
    ...
    <div className="min-h-full bg-[#F5F7FA]">
      <div className="bg-white border-b border-gray-200 px-4 md:px-6 pt-4 pb-4">
        <div className="max-w-5xl mx-auto">
          ...
          {retrainTasksSectionVisibility.headerDescription && (
            <p className="text-sm text-gray-500">把“哪里薄弱”拆成能执行的动作，按顺序完成更容易形成闭环。</p>
          )}

          {retrainTasksSectionVisibility.overviewStats && (
      ...
      <div className={retrainTasksLayoutClass}>
        <div className={retrainTasksMainColumnClass}>
                  ...
                  <div key={task.id} className="p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {retrainTasksSectionVisibility.taskDescription && (
                          <p className="text-xs text-gray-500 leading-relaxed mb-2">{task.desc}</p>
                        )}
                        {retrainTasksSectionVisibility.taskMeta && (
          ...
          {retrainTasksSectionVisibility.completionLoopPanel && (
        ...
        {showRetrainTasksRightSidebar && (
          <div className="space-y-4">
            {retrainTasksSectionVisibility.suggestionSidebar && (
              <div className="bg-white rounded-xl shadow-sm p-4">
                <div className="flex items-center gap-2 mb-3">
            ...
            {retrainTasksSectionVisibility.quickLinksSidebar && (
              <div className="bg-white rounded-xl shadow-sm p-4">
