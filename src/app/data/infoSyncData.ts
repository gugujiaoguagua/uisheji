...
export const updates: Update[] = [
  {
    ...
    syncLinks: [
      { label: "培训课件", owner: "培训运营", status: "done", note: "规范讲义已更新到 v3.1。" },
      { label: "考核题库", owner: "培训运营", status: "pending", note: "仍有 8 道旧厚度标准题未替换。" },
      { label: "AI 陪练场景", owner: "培训运营", status: "pending", note: "卫浴施工解释场景仍沿用旧口径。" },
  ...
  },
  {
    ...
    impactScopes: [
      ...
      { label: "学习中心资料", owner: "培训运营", severity: "low", note: "学习中心和课件已全量更新。" },
      { label: "陪练训练场景", owner: "AI 陪练", severity: "low", note: "新品推荐场景已切换到新参数。" },
    ],
    syncLinks: [
      { label: "培训课件", owner: "培训运营", status: "done", note: "课件与学习中心已全量更新。" },
      { label: "考核题库", owner: "培训运营", status: "done", note: "R10 相关题已全部替换并上线。" },
      { label: "AI 陪练场景", owner: "培训运营", status: "done", note: "卫浴推荐场景已切换到新参数。" },
  ...
  },
  {
    ...
    impactScopes: [
      ...
      { label: "培训题库答案解析", owner: "培训运营", severity: "medium", note: "题目已补，但答案解释还不够强。" },
      { label: "案例库沉淀", owner: "销设协同", severity: "medium", note: "高频异议尚未形成标准案例可复用。" },
    ],
    syncLinks: [
      { label: "培训课件", owner: "培训运营", status: "done", note: "讲义已同步新结构。" },
      { label: "考核题库", owner: "培训运营", status: "risk", note: "题库已补，但正确答案解释仍较弱。" },
      { label: "AI 陪练场景", owner: "培训运营", status: "pending", note: "价格异议场景还未换成新话术。" },
